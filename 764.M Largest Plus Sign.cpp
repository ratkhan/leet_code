/*
Most straight forward and brute solution. 
Very slow too. 
Could start looking for biggest plus signed from the middle. If max plus signed found
can return, because no bigger plus sign is possible in matrix that size;
*/
#include <iostream>
#include <string>
#include <vector>
